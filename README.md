...
After the season ended I finished updating the game results based on the algorithm's prediction and once again, surprisingly it accurately predicted the champion. I personally thought this was a year for Los Angeles Clippers due to them being the deepest team in the league, but they were upset by the Denver Nuggets. 
